    ...
    */
    ...
    open func update() {
        ...
        func addHighlightView(startingPosition starting: CGFloat, width: CGFloat) {
           ...
           self.addSubview(highlightView)  // Comment For Testing
        }
    ...
    @objc fileprivate func segmentPressed(_ sender: UIButton) {
        ...
        addUnderLineToSelectedSegment(sender: self as! DCUIFSegmentControl);
    }
    ...
    public func addUnderLineToSelectedSegment(sender: DCUIFSegmentControl)
    {
        return;
...
//            //UIColor.init(red: 186/255, green: 0/255, blue: 0/255, alpha: 1).cgColor;
//        segmentBottomBorder.borderWidth = 3
//        let x = CGFloat(sender.selectedSegment) * (sender.frame.size.width/3)
