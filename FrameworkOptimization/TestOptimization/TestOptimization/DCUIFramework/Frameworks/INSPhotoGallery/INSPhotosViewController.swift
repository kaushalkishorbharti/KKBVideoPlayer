...
public protocol INSPhotosViewControllerDelegate{
    
    func imageTappedAtIndex(index:Int);
...
open class INSPhotosViewController: UIViewController, UIPageViewControllerDataSource, UIPageViewControllerDelegate, UIViewControllerTransitioningDelegate {
    ...
    public var delegate:INSPhotosViewControllerDelegate?;
    /* 
    ...
    @objc private func handleSingleTapGestureRecognizer(_ gestureRecognizer: UITapGestureRecognizer) {
        ...
        //overlayView.setHidden(false, animated: true);
        self.delegate?.imageTappedAtIndex(index: self.dataSource.indexOfPhoto(currentPhoto!)!)
