...
@IBDesignable open class ActiveLabel: UILabel {
    ...
    @IBInspectable open var URLColor: UIColor = DCUIFColor.PrimaryGreen.getColor() {
        didSet { updateTextStorage(parseText: false) }
    }
    ...
    override open var attributedText: NSAttributedString? {
        didSet { updateTextStorageAttributed() }
    }
    ...
    func onTapGesture(tapGesture:UITapGestureRecognizer){
        ...
        if let selectedElement = element(at: location){
    ...
    public var isTapGestureEnable:Bool = false {
        didSet{
            if(isTapGestureEnable){
                let gesture:UITapGestureRecognizer = UITapGestureRecognizer.init(target: self, action: #selector(tapEvent(tap:)))
    ...
    @objc public func tapEvent(tap:UITapGestureRecognizer){
      
        onTapGesture(tapGesture: tap)
        
    }
    fileprivate func updateTextStorageAttributed(parseText: Bool = true) {
