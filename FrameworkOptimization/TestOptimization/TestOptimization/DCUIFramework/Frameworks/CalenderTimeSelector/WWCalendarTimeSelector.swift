...
open class WWCalendarTimeSelector: UIViewController, UITableViewDelegate, UITableViewDataSource, WWCalendarRowProtocol, WWClockProtocol {
    ...
    fileprivate var defaultTopPanelTitleForMultipleDates = "Select Multiple Dates"
    ...
    open override func viewDidLoad() {
        ...
        if DCUIFramework.language == "vi" {
          optionButtonTitleDone = "Xong"
          optionButtonTitleCancel = "Hủy bỏ"
          defaultTopPanelTitleForMultipleDates = "Chọn nhiều ngày"
        }
    ...
    open func scrollViewDidScroll(_ scrollView: UIScrollView) {
        ...
        DispatchQueue.main.async { [unowned self] in
            self.refreshTblAfterScroll(scrollView)
        }
        return
...
//                scrollView.setContentOffset(CGPoint(x: 0, y: offsetY + twoRow * 2), animated: true)
//                calendarTable.reloadData()
//            }
...
//                //scrollView.setContentOffset(CGPoint(x: 0, y: offsetY + triggerPoint * 2), animated: false)
//                yearTable.reloadData()
//            }
...
//        }
    ...
    private func refreshTblAfterScroll(_ scrollView: UIScrollView) {
        let offsetY = scrollView.contentOffset.y
