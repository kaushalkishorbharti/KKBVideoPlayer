...
public protocol YKCircleCropViewControllerProtocol: YKCircleCropViewControllerDelegate {
}

extension YKCircleCropViewControllerProtocol {
   public func presentCircleCropViewController(_ image: UIImage) {
        let circleCropController = YKCircleCropViewController()
        circleCropController.image = image
        circleCropController.delegate = self
        DCUIFViewController.getTopViewController().present(circleCropController, animated: true, completion: nil)
    }
}
