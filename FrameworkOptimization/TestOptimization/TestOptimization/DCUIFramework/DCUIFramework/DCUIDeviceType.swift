...
public enum DCUIDeviceType: String, CaseIterable {
    case iPhone2G
    ...
    public static var current: DCUIDeviceType {
        ...
        return DCUIDeviceType(identifier: identifier)
    }
    ...
    internal init(identifier: String) {
        ...
        for device in DCUIDeviceType.allCases {
...
public extension DCUIDeviceType {
    
    /// The `DeviceType` of the device in use
    var deviceType: DCUIDeviceType {
        return DCUIDeviceType.current
    }
}
